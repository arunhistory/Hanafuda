...
const checks=[
  ...
  ['settings exposes Cloudflare terms credits and licenses',ts.includes('data-nav="terms">利用規約')&&ts.includes('data-nav="credits">クレジット')&&ts.includes('data-nav="licenses">ライセンス')],
  ...
  ['audio WASM execution is admitted by CSP',html.includes("script-src 'self' 'wasm-unsafe-eval'")&&!html.includes("script-src 'self' 'unsafe-eval'")],
